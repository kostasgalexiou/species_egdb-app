...
def extract_fasta(fasta, range, allele_info, infile_dict=od()):
    output_list = list()

    if allele_info:
        header = ['#id', 'chrom', 'genome_ref_allele', 'pos', 'ref', 'alt', 'sequence']
    else:
        header = ['#id', 'chrom', 'genome_ref_allele', 'pos', 'sequence']
